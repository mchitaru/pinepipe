...
class LanguageController extends Controller
{
    ...
    public function index($currantLang)
    {
        if(\Auth::user()->can('manage language')){
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('create language'))
        {
            ...
            return redirect()->route('languages.index',[$langCode])->with('success',__('Language Created Successfully!'));
        }else{
            return redirect()->back();
        }
    ...
    public function update(Request $request, $currantLang)
    {
        if(\Auth::user()->can('create language')){
            ...
            return redirect()->route('languages.index',[$currantLang])->with('success',__('Language Save Successfully!'));
        }else{
            return redirect()->back();
        }
