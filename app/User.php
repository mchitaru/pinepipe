    ...
    public function initCompanyDefaults()
    {
        ...
        $task = Task::create(
            [
                ...
                'due_date'  => Carbon::now(\Auth::user()?\Auth::user()->timezone:null),
        ...
        Timesheet::create(
            [
                ...
                'user_id' => $id,
                'task_id' => $task->id,
                'date' => Carbon::now(\Auth::user()?\Auth::user()->timezone:null),
                'rate' => 50,
                'hours' => 8,
                'minutes' => 0,
                'seconds' => 0,
        ...
        Invoice::create(
            [
                ...
                'project_id' => $project->id,
                'status' => 0,
                'issue_date' => Carbon::now(\Auth::user()?\Auth::user()->timezone:null),
                'due_date' => Carbon::now(\Auth::user()?\Auth::user()->timezone:null)->addDays(30),
                'discount' => '0',
                'tax_id' => null,
                'notes' => null,
                'user_id' => $id,
