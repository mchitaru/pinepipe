...
<div class="row" data-id = "{{$subtask->id}}" tabindex="{{$key}}">
    ...
    <div class="custom-control custom-checkbox col">
        ...
        <div class="col">
            <input class="col" type="text" name="title" id="title-{{$subtask->id}}" placeholder="{{__('Subtask item')}}" value="{{$subtask->title}}" data-filter-by="value" data-url="{{route('tasks.subtask.update', [$task->id,$subtask->id])}}" data-remote="true" data-method="patch" data-type="text" data-disable="true"/>
