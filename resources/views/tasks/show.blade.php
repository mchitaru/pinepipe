...
<div class="modal-body container-fluid">
 <div class="row justify-content-center">
    <div class="col">
        ...
        <form  method="post" enctype="multipart/form-data" class="modal fade" id="note-add-modal" tabindex="-1" aria-hidden="true" action="{{route('tasks.comment.store',[$task->project_id,$task->id])}}">
            @csrf
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header">
