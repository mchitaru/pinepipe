...
<div class="tab-content">
    ...
    <div class="form-group row align-items-center required">
        ...
        {!! Form::select('client_id', $clients, $client_id, array('class' => (Gate::check('create client')?'tags':'').' form-control col', empty($client_id)?'':'disabled', 'required'=>'required', 'placeholder'=>'...', 
    ...
    <div class="form-group row">
        ...
        {!! Form::select('lead_id', $leads, $lead_id, array('class' => (Gate::check('create lead')?'tags':'').' form-control col', empty($lead_id)?'':'disabled', 'placeholder' =>'...', 'lang'=>\Auth::user()->locale)) !!}
    </div>
    @endif
    <hr>
    <h6>{{__('Timeline')}}</h6>
